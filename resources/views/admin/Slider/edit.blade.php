        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data"  action="{{url(LaravelLocalization::setLocale().'/admin/slider/'.$slider->first()->id)}}">
                      {{csrf_field()}}
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="title" class="form-control" id="name" placeholder="Title News" value="{{ $slider->first()->title }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="description" class="form-control" id="name" placeholder="Title News" value="{{ $slider->first()->description }}">
                            </div>
                        ...
                        <label for="username" class="col-sm-4 control-label">image</label>
                            ...
                            <div class="col-sm-4 {{ $errors->has('username') ? ' has-error' : '' }}">
                                <input type="file" name="image" class="form-control" id="image" placeholder="image" value="{{ $slider->first()->image }}">
                                @if ($errors->has('image'))
