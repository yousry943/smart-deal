          ...
          <div class="container ulockd-pdng0">
              ...
              <div class="collapse navbar-collapse pad330-md" id="navbar-menu">
                  <ul class="nav navbar-nav navbar-left" data-in="fadeIn">
                      <li class="dropdown">
                          <a href="{{url('/'.LaravelLocalization::setLocale())}}" >Home</a>
                    ...
                    <li><a href="{{url(LaravelLocalization::setLocale().'/news/'.$get_category_new->id) }}">{{$get_category_new->name}} </a></li>
                      ...
                      <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Market Analysis</a>
                              <ul class="dropdown-menu">
                    ...
                    @endforeach
                      ...
                      <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Live</a>
                          <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                      ...
                      <li >
                          <a href="{{url(LaravelLocalization::setLocale().'/service/') }}" class="dropdown-toggle" data-toggle="dropdown">Service </a>
                              <!-- <ul class="dropdown-menu">
                    ...
                    <li><a href="forex-news.html">Vps</a></li>
                      ...
                      <li>
                          <a href="{{url(LaravelLocalization::setLocale().'/Articles/') }}" class="dropdown-toggle" data-toggle="dropdown">Articles </a>
                              <!-- <ul class="dropdown-menu">
                    <li><a href="forex-news.html">Signal </a></li>
                    <li><a href="forex-news.html">Vps</a></li>
                      ...
                      <li>
                    <a class="dropdown-toggle" href="{{url(LaravelLocalization::setLocale().'/team/') }}" data-toggle="modal" data-target=".bs-example-modal-lg" data-whatever="@mdo"><i class="fa fa-edit color-white"></i>Team</a>

                                                              </li>


                                                              <li>
                                                            <a class="dropdown-toggle" href="{{url('contact')}}" data-toggle="modal" data-target=".bs-example-modal-lg" data-whatever="@mdo"><i class="fa fa-edit color-white"></i>contact</a>
